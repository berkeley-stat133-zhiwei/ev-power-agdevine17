...
ev_by_state <- read.csv("ev-registrations-by-state-2023.csv")
```
I am having trouble creating my us_states object to create my map visualization.

```{r}
us_joined <- us_states |>
    left_join(ev_by_state)
```
